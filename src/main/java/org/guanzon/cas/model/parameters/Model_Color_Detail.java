 ...
 */
public class Model_Color_Detail implements GEntity {

    final String XML = "Model_Color_Detail.xml";
     ...
     */
    public Model_Color_Detail(GRider foValue) {
        if (foValue == null) {
    ...
    /**
     * Sets the xMnColorx of this record.
     *
     * @param fsValue
     * @return result as success/failed
     */
