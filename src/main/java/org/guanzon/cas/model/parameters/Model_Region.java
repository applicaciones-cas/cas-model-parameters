 ...
 */
public class Model_Region implements GEntity {

    final String XML = "Model_Region.xml";
     ...
     */
    public Model_Region(GRider foValue) {
        if (foValue == null) {
    ...
    public JSONObject openRecord(String fsCondition) {
        ...
        lsSQL = MiscUtil.addCondition(lsSQL, "sRegionID = " + SQLUtil.toSQL(fsCondition));
    ...
    public JSONObject saveRecord() {
        ...
        if (pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE) {
            ...
            if (pnEditMode == EditMode.ADDNEW) {
                ...
                Model_Region loOldEntity = new Model_Region(poGRider);

                //replace with the primary key column info
                JSONObject loJSON = loOldEntity.openRecord(this.getRegionID());
    ...
    /**
     * Description: Sets the sRegionNm of this record.
     *
     * @param fsValue
     * @return result as success/failed
     */
    ...
    /**
     * @return The sRegionNm of this record.
     */
    ...
    /**
     * Description: Sets the nMinWages of this record.
     *
     * @param fsValue
     * @return result as success/failed
     */
    ...
    /**
     * Description: Sets the nColaAmtx of this record.
     *
     * @param fsValue
     * @return result as success/failed
     */
    ...
    /**
     * Description: Sets the nMinWage2 of this record.
     *
     * @param fsValue
     * @return result as success/failed
     */
    ...
    /**
     * Description: Sets the nColaAmt2 of this record.
     *
     * @param fsValue
     * @return result as success/failed
     */
