 ...
 */
public class Model_Model_Series implements GEntity {

    final String XML = "Model_Model_Series.xml";
     ...
     */
    public Model_Model_Series(GRider foValue) {
        if (foValue == null) {
    ...
    public JSONObject newRecord() {
        ...
        setSeriesID(MiscUtil.getNextCode(getTable(), "sSeriesID", true, poGRider.getConnection(), ""));
    ...
    public JSONObject saveRecord() {
        ...
        if (pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE) {
            ...
            if (pnEditMode == EditMode.ADDNEW) {
                ...
                Model_Model_Series loOldEntity = new Model_Model_Series(poGRider);

                //replace with the primary key column info
                JSONObject loJSON = loOldEntity.openRecord(this.getSeriesID());

                if ("success".equals((String) loJSON.get("result"))) {
                    //replace the condition based on the primary key column of the record
                    lsSQL = MiscUtil.makeSQL(this, loOldEntity, "sSeriesID = " + SQLUtil.toSQL(this.getSeriesID()));
