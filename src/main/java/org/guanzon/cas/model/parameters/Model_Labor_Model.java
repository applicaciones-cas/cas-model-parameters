 ...
 */
public class Model_Labor_Model implements GEntity {

    final String XML = "Model_Labor_Model.xml";
     ...
     */
    public Model_Labor_Model(GRider foValue) {
        if (foValue == null) {
    ...
    public JSONObject saveRecord() {
        ...
        if (pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE) {
            ...
            if (pnEditMode == EditMode.ADDNEW) {
                ...
                Model_Labor_Model loOldEntity = new Model_Labor_Model(poGRider);
                ...
                if ("success".equals((String) loJSON.get("result"))) {
                    //replace the condition based on the primary key column of the record
                    lsSQL = MiscUtil.makeSQL(this, loOldEntity, "sLaborIDx = " + SQLUtil.toSQL(this.getLaborID()), "xModelNme");
    ...
    /**
     * Description: Sets the xModelNme of this record.
     *
     * @param fsValue
     * @return result as success/failed
     */
    ...
    /**
     * @return The xModelNme of this record.
     */
    ...
    public String makeSQL() {
        return MiscUtil.makeSQL(this, "xModelNme");
    }
    ...
    public String makeSelectSQL() {
        return MiscUtil.makeSelect(this, "xModelNme");
    }
