 ...
 */
public class Model_Company implements GEntity {

    final String XML = "Model_Company.xml";
     ...
     */
    public Model_Company(GRider foValue) {
        if (foValue == null) {
    ...
    public JSONObject newRecord() {
        ...
        setCompnyID(MiscUtil.getNextCode(getTable(), "sCompnyID", false, poGRider.getConnection(), ""));
    ...
    public JSONObject openRecord(String fsCondition) {
        ...
        lsSQL = MiscUtil.addCondition(lsSQL, " sCompnyID = " + SQLUtil.toSQL(fsCondition));
        ...
        if (pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE) {
            ...
            if (pnEditMode == EditMode.ADDNEW) {
                ...
                if ("success".equals((String) loJSON.get("result"))) {
                    //replace the condition based on the primary key column of the record
                    lsSQL = MiscUtil.makeSQL(this, loOldEntity, "sCompnyID = " + SQLUtil.toSQL(this.getCompanyID()));
