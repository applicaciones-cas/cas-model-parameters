 ...
 */
public class Model_Category_Level2 implements GEntity {

    final String XML = "Model_Category_Level2.xml";
     ...
     */
    public Model_Category_Level2(GRider foValue) {
        if (foValue == null) {
    ...
    public JSONObject saveRecord() {
        ...
        if (pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE) {
            ...
            if (pnEditMode == EditMode.ADDNEW) {
                ...
                Model_Category_Level2 loOldEntity = new Model_Category_Level2(poGRider);
                ...
                if ("success".equals((String) loJSON.get("result"))) {
                    //replace the condition based on the primary key column of the record
                    lsSQL = MiscUtil.makeSQL(this, loOldEntity, "sCategrCd = " + SQLUtil.toSQL(this.getCategoryCode()), "xInvTypNm»xMainCatx");
    ...
    /**
     * Sets the Category_Level2 RecdStat of this record.
     *
     * @param fsValue
     * @return result as success/failed
     */
    ...
    /**
     * @return The Category_Level2 RecdStat of this record.
     */
