...
public class Model_Country implements GEntity {
    ...
    final String XML = "Model_Country.xml";
     ...
     */
    public Model_Country(GRider foValue) {
        if (foValue == null) {
        ...
        if (pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE) {
            ...
            if (pnEditMode == EditMode.ADDNEW) {
                ...
                if ("success".equals((String) loJSON.get("result"))) {
                    //replace the condition based on the primary key column of the record
                    lsSQL = MiscUtil.makeSQL(this, loOldEntity, "sCntryCde = " + SQLUtil.toSQL(this.getCountryCode()));
     ...
     * @return result as success/failed
     */
    public JSONObject setNational(String fsValue) {
        return setValue("sNational", fsValue);
    }
