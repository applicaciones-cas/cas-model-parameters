...
public class Model_Province implements GEntity{
    final String XML = "Model_Province.xml";
     ...
     */
    public Model_Province(GRider foValue){
        if (foValue == null){
    ...
    public JSONObject newRecord() {
        ...
        setProvIDxx(MiscUtil.getNextCode(getTable(), "sProvIDxx", true, poGRider.getConnection(), poGRider.getBranchCode()));
