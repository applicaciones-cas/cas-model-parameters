 ...
 */
public class Model_Section implements GEntity {

    final String XML = "Model_Section.xml";
     ...
     */
    public Model_Section(GRider foValue) {
        if (foValue == null) {
    ...
    public JSONObject newRecord() {
        ...
        setSectionID(MiscUtil.getNextCode(getTable(), "sSectnIDx", false, poGRider.getConnection(), poGRider.getBranchCode()));
    ...
    public JSONObject openRecord(String fsCondition) {
        ...
        lsSQL = MiscUtil.addCondition(lsSQL, "sSectnIDx = " + SQLUtil.toSQL(fsCondition));
    ...
    public JSONObject saveRecord() {
        ...
        if (pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE) {
            ...
            if (pnEditMode == EditMode.ADDNEW) {
                ...
                Model_Section loOldEntity = new Model_Section(poGRider);

                //replace with the primary key column info
                JSONObject loJSON = loOldEntity.openRecord(this.getSectionID());

                if ("success".equals((String) loJSON.get("result"))) {
                    //replace the condition based on the primary key column of the record
                    lsSQL = MiscUtil.makeSQL(this, loOldEntity, "sSectnIDx = " + SQLUtil.toSQL(this.getSectionID()));
    ...
    /**
     * Description: Sets the sSectnIDx of this record.
     *
     * @param fsValue
     * @return result as success/failed
     */
    ...
    /**
     * @return The sSectnIDx of this record.
     */
